...
describe PaymentsController do
  ...
  let(:valid_attributes) { { "medical_treatment" => "" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved payment as @payment" do
        ...
        post :create, {:payment => { "medical_treatment" => "invalid value" }}, valid_session
        assigns(:payment).should be_a_new(Payment)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested payment" do
        ...
        Payment.any_instance.should_receive(:update).with({ "medical_treatment" => "" })
        put :update, {:id => payment.to_param, :payment => { "medical_treatment" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the payment as @payment" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Payment.any_instance.stub(:save).and_return(false)
        put :update, {:id => payment.to_param, :payment => { "medical_treatment" => "invalid value" }}, valid_session
        assigns(:payment).should eq(payment)
      end
