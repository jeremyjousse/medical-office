...
describe BankAccountsController do
  ...
  let(:valid_attributes) { { "bank_name" => "MyString" } }
  ...
  describe "GET index" do
    it "assigns all bank_accounts as @bank_accounts" do
      ...
      assigns(:bank_accounts).should eq([bank_account])
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved bank_account as @bank_account" do
        ...
        post :create, {:bank_account => { "bank_name" => "invalid value" }}, valid_session
        assigns(:bank_account).should be_a_new(BankAccount)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested bank_account" do
        ...
        BankAccount.any_instance.should_receive(:update).with({ "bank_name" => "MyString" })
        put :update, {:id => bank_account.to_param, :bank_account => { "bank_name" => "MyString" }}, valid_session
      end
      ...
      it "redirects to the bank_account" do
        bank_account = BankAccount.create! valid_attributes
        put :update, {:id => bank_account.to_param, :bank_account => valid_attributes}, valid_session
        response.should redirect_to(bank_account)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the bank_account as @bank_account" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        BankAccount.any_instance.stub(:save).and_return(false)
        put :update, {:id => bank_account.to_param, :bank_account => { "bank_name" => "invalid value" }}, valid_session
        assigns(:bank_account).should eq(bank_account)
      end
